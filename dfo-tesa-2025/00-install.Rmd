...
- Rtools 4.5 (if installing the development version below; or 4.4 to match R 4.4)
...
Optional, but you can install development version of sdmTMB from GitHub. This requires a C++ compiler or the Rtools application on Windows.
