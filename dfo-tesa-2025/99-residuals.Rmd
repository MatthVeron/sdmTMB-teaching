...
where `y`, are the observation and `s1` and `s2` are estimated in the model.
...
- How do we treat the fixed and random effects?

- Do we use theoretical or simulation-based quantiles
...
- Set random effects to one of:
  ...
  - One sample drawn from their precision matrix*
  - One sample drawn from an MCMC chain
  
*Usually, I would suggest using this
...
- Simulation-based residuals can work for any model
