...
cat("LPD difference (anisotropic - isotropic):", round(elpd_diff, 2), "±", round(se_diff, 2), "\n")
```
...
4.  We assigned folds. What happens if you don't do this? Why might you want to set the random seed first?
5.  How else could you use the folds?
